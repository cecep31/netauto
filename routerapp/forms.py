...
class auto2Form(forms.Form):
    limitat = forms.CharField(widget=forms.NumberInput({'class':'form-control', 'placeholder': 'dalam kilobyte / boleh juga kosongkan'}),label="kecepatan minimum",max_length=50, required=False)
